      ...
      <div className="content bg-white " id="content">
        <div className="content-inner p-16">
          <div className="box-container">
            ...
            <section>
              <div className="text-[#2f2f2f] text-[24px] ">
                <div>
                  <p>
            ...
            <section >
              <img src="/content_img_01.png" className="w-[100%]" alt="" />
              <img src="/content_img_02.png" className="w-[100%]" alt="" />
              <img src="/content_img_03.png" className="w-[100%]" alt="" />
            </section>
                ...
                <div className="text-[#2f2f2f]  flex flex-col mt-20">
                  <fieldset className="pr10">
                    ...
                    <figure className="text-xl pt-2">
                      {t('content.camp1_desc_1')} <br />
                      {t('content.camp1_desc_2')}
                    </figure>
                  </fieldset>
                  <fieldset className="pr10 mt-8">
                    ...
                    <figure className="text-xl pt-2">
                      {t('content.camp2_desc_1')} <br />
                      {t('content.camp2_desc_2')}
                    </figure>
                  </fieldset>
                  <fieldset className="pr10 mt-8">
                    <figcaption className="text-primary  text-4xl">
                    ...
                    <figure className="text-xl pt-2">
                      {t('content.camp3_desc_1')} <br />
                      {t('content.camp3_desc_2')} <br />{' '}
                      {t('content.camp3_desc_3')}
                      {/* <br /> 
                    {t('content.camp3_desc_4')} */}
                    </figure>
                  </fieldset>
                  <fieldset className="pr10 mt-8">
                    <figcaption className="text-primary  text-4xl">
                  ...
                  <fieldset className="pr10 mt-8">
                    ...
                    <figure className="text-[17px] pt-2">
                      {t('content.camp5_desc_1')} <br />
                      {t('content.camp5_desc_2')} <br />{' '}
                      {t('content.camp5_desc_3')}
                    </figure>
                  </fieldset>
                </div>
                <div className="mt-15 flex-row">
                  <img
                    className="vertical-bottom w-[100%]"
                    src="/content_img_04.png"
                    alt=""
                  />
                  <img
                    className="vertical-bottom w-[100%]"
                    src="/content_img_05.png"
                    alt=""
                  />
                  <img
                    className="vertical-bottom w-[100%]"
                    src="/content_img_06.png"
                    alt=""
                  />
                  <img
                    className="vertical-bottom w-[100%]"
                    src="/content_img_07.png"
                    alt=""
                  />
                </div>
              </section>
                ...
                <div className="text-[#2f2f2f]  mt-20">
                  ...
                  <fieldset className="pr10 mt-8">
                    ...
                    <figure className="text-[17px] pt-2">
                      沐浴在苍山自然风光下的电子乐派对
                      <br />{' '}
                      我们将在黄昏前后的霍比特村小木屋上进行一场别开生面的演出，盛邀大理高水准音乐
                      DJ 和两只羊驼到场
                      <br />
                      山峦绚烂，晚霞如锦，原生态的天然环境将打造出一场特别而难忘的绝妙体验。
                    </figure>
                  </fieldset>
                  <fieldset className="pr10 mt-8">
                    <figcaption className="text-primary  text-4xl">
                  ...
                  <fieldset className="pr10 mt-8">
                    ...
                    <figure className="text-[17px] pt-2">
                      一片建设在天然草地上的运动场，我们将邀请专业的户外玩家带领大家一起畅玩，开展飞盘、毽子、橄榄球、电动滑板等运动，以及桌游、棋牌等帐篷内部游戏
                      <br />{' '}
                      尽情享受苍山洱海风光中的草坪运动，挥洒汗水，结交朋友
                    </figure>
                  </fieldset>
                  <fieldset className="pr10 mt-8">
                    <figcaption className="text-primary  text-4xl">
